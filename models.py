...
class Conversation(db.Model):
    ...
    messages = db.relationship('Message', backref='conversation', lazy='dynamic', cascade="all, delete-orphan") # Use lazy='dynamic' for better filtering/ordering queries
...
class Message(db.Model):
    ...
    __table_args__ = (db.Index('idx_message_conversation_id_created_at', 'conversation_id', 'created_at'),)
